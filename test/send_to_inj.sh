...
etherman --name Peggy --source "$peggy_contract" -P "$deployer_pk" tx "$peggy_contract_address" sendToInjective "$inj_coin_contract_address" 000000000000000000000000727aee334987c52fa7b567b2662bdbb68614e48c 10 ""
