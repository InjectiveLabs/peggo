...
func (msg *MsgValsetConfirm) ValidateBasic() (err error) {
	...
	if err := util.ValidateEthAddress(msg.EthAddress); err != nil {
...
func (msg MsgSetEthAddress) ValidateBasic() error {
	...
	if err := util.ValidateEthAddress(msg.Address); err != nil {
		return sdkerrors.Wrap(err, "ethereum address")
	}
	...
	err = util.ValidateEthereumSignature(crypto.Keccak256(val.Bytes()), sigBytes, msg.Address)
	if err != nil {
...
func (msg MsgSendToEth) ValidateBasic() error {
	...
	if err := util.ValidateEthAddress(msg.EthDest); err != nil {
		return sdkerrors.Wrap(err, "ethereum address")
	}
...
func (msg MsgConfirmBatch) ValidateBasic() error {
	...
	if err := util.ValidateEthAddress(msg.EthSigner); err != nil {
		return sdkerrors.Wrap(err, "eth signer")
	}
	if err := util.ValidateEthAddress(msg.TokenContract); err != nil {
...
func (e *MsgDepositClaim) ValidateBasic() error {
	...
	if err := util.ValidateEthAddress(e.EthereumSender); err != nil {
		return sdkerrors.Wrap(err, "eth sender")
	}
	if err := util.ValidateEthAddress(e.TokenContract); err != nil {
