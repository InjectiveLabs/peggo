...
// ReentrantERC20MetaData contains all meta data concerning the ReentrantERC20 contract.
var ReentrantERC20MetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_gravityAddress\",\"type\":\"address\"}],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"transfer\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
	Sigs: map[string]string{
		"a9059cbb": "transfer(address,uint256)",
	},
	Bin: "",
}

// ReentrantERC20ABI is the input ABI used to generate the binding from.
// Deprecated: Use ReentrantERC20MetaData.ABI instead.
var ReentrantERC20ABI = ReentrantERC20MetaData.ABI

// Deprecated: Use ReentrantERC20MetaData.Sigs instead.
// ReentrantERC20FuncSigs maps the 4-byte function signature to its string representation.
var ReentrantERC20FuncSigs = ReentrantERC20MetaData.Sigs

// ReentrantERC20Bin is the compiled bytecode used for deploying new contracts.
// Deprecated: Use ReentrantERC20MetaData.Bin instead.
var ReentrantERC20Bin = ReentrantERC20MetaData.Bin

// DeployReentrantERC20 deploys a new Ethereum contract, binding an instance of ReentrantERC20 to it.
func DeployReentrantERC20(auth *bind.TransactOpts, backend bind.ContractBackend, _gravityAddress common.Address) (common.Address, *types.Transaction, *ReentrantERC20, error) {
	parsed, err := ReentrantERC20MetaData.GetAbi()
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	if parsed == nil {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(ReentrantERC20Bin), backend, _gravityAddress)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
...
func (_ReentrantERC20 *ReentrantERC20Transactor) Transfer(opts *bind.TransactOpts, arg0 common.Address, arg1 *big.Int) (*types.Transaction, error) {
	return _ReentrantERC20.contract.Transact(opts, "transfer", arg0, arg1)
}

// Transfer is a paid mutator transaction binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(address , uint256 ) returns(bool)
func (_ReentrantERC20 *ReentrantERC20Session) Transfer(arg0 common.Address, arg1 *big.Int) (*types.Transaction, error) {
	return _ReentrantERC20.Contract.Transfer(&_ReentrantERC20.TransactOpts, arg0, arg1)
}

// Transfer is a paid mutator transaction binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(address , uint256 ) returns(bool)
func (_ReentrantERC20 *ReentrantERC20TransactorSession) Transfer(arg0 common.Address, arg1 *big.Int) (*types.Transaction, error) {
	return _ReentrantERC20.Contract.Transfer(&_ReentrantERC20.TransactOpts, arg0, arg1)
}
