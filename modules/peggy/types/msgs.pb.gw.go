...
var (
	...
	pattern_Msg_SetOrchestratorAddresses_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"peggy", "v1", "set_orchestrator_address"}, "", runtime.AssumeColonVerbOpt(true)))
)
